...
import com.example.hello.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.example.hello.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.example.hello.config.dbmigrations");
